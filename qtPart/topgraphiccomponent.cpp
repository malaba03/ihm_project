...
TopGraphicComponent::TopGraphicComponent(QPixmap pM,int type):
 ...
 *
 */
void TopGraphicComponent::adjustSize(int x, int y)
{
    _width += x;
    _height += y;
...
/**
  ...
  */
bool TopGraphicComponent::sceneEventFilter ( QGraphicsItem * watched, QEvent * event )
{
...
QRectF TopGraphicComponent::boundingRect() const
{
...
void TopGraphicComponent::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
...
/*void TopGraphicComponent::mouseMoveEvent ( QGraphicsSceneMouseEvent * event ){
...
void TopGraphicComponent::mousePressEvent (QGraphicsSceneMouseEvent * event ){
...
void TopGraphicComponent::mouseReleaseEvent (QGraphicsSceneMouseEvent * event ){
...
void TopGraphicComponent::hoverLeaveEvent ( QGraphicsSceneHoverEvent * )
{
    _outterborderColor = Qt::black;
...
void TopGraphicComponent::hoverEnterEvent ( QGraphicsSceneHoverEvent * )
{
...
void TopGraphicComponent::setCornerPositions()
{
...
void TopGraphicComponent::mouseMoveEvent(QGraphicsSceneDragDropEvent *event)
{
  event->setAccepted(true);
}

void TopGraphicComponent::mousePressEvent(QGraphicsSceneDragDropEvent *event)
{
    event->setAccepted(true);
}
